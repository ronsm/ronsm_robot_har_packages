...
class QuerySelection():
    def __init__(self):
        ...
        self.label_fork_if_matches = None
    ...
    def query_select(self, prediction_h, prediction_s, prediction_h_f, prediction_s_f, consistent_s, consistent_s_f, agree):
        ...
        if query:
            ...
            self.set_waiting_for_response(True, query_type, prediction_s, prediction_s_f, label_fork_if_matches)

    def set_waiting_for_response(self, yes_no, query_type=None, prediction_s=None, prediction_s_f=None, label_fork_if_matches=None):
        if not yes_no:
            self.waiting_for_response = False
            self.query_type = 0
            self.prediction_s = None
            ...
            self.label_fork_if_matches = label_fork_if_matches
